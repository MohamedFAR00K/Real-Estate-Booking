                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4"><span class="text-success">Manjoor Real Estate</span><br>
                            Guide you Home</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Real estate is a tangible asset not a service. A product is usually an asset that is sold. It is something that is considered a noun, a person, place or thing. So with that definition, a house is a thing which would make it an product.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Rental Services means the provision and support of work station computing hardware.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>A listing in real estate allows sellers to show their property is for sale in the real estate market.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>The 1% rule of investing in real estate compares the purchase price of an investment property to the gross income it will generate.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>DLF is one of the largest and best real estate companies in India. They have developed numerous residential, commercial, and retail projects across the country.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Real Estate Experience means sufficient experience, as reasonably determined by Lessor, in the ownership, operation, management .</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Real estate agent include rapport with other agents, knowledge of market trends, and solid referrals..</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Home prices and home sales (overall and in your desired market) New construction. Property inventory.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>You can describe their work processes, responsibility and ethic for potential clients to visualize how that person can fulfill their real estate needs.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Aquire Real Estate are Premiere Real Estate Agents achieving amazing results.</p>
                        </div>
                    </div>
                </div>
            </div>
