...
// Fetch property name and price from database
$sql = "SELECT price, title FROM property WHERE id = 1"; // Assuming you want to fetch data for a specific property (e.g., property with ID 1)
...
<div class="col-lg-4">
    <div class="sidebar-widget">
        <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Update Property</h4>
        ...
        <form class="d-inline-block w-100" action="calc.php" method="post">
            ...
            <div class="input-group mb-2 mr-sm-2">
                ...
                <input type="text" class="form-control" name="propertyName" placeholder="Property Name" value="<?php echo $propertyName; ?>" required>
            </div>
            ...
            <div class="input-group mb-2 mr-sm-2">
                ...
                <input type="text" class="form-control" name="propertyPrice" placeholder="Property Price" value="<?php echo $propertyPrice; ?>" required>
            </div>
