...
<!-- Meta Tags -->
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="MANJOOR">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4"></h4>
                        <form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="text" value="<?php echo $row['1'];?>" placeholder="Property Name">
                            </div>
                            
                        <form class="d-inline-block w-100" action="calc.php" method="post">
                            <label class="sr-only">Property Amount</label>
                            <div class="text-success text-left h5 my-2 text-md-left"> ₹<?php echo $row['13'];?></div>
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">₹</div>
                                </div>
                            ...
                            <button type="submit" value="submit" name="calc" class="btn btn-danger mt-4">BOOK NOW</button>
                        </form>
                                        ...
                                        if(isset($_POST['add']))
{
    ...
    $amount = $_POST['amount']; // Get property amount from form

    // ... (other code remains unchanged)

    $sql="INSERT INTO property (title, pcontent, type, bhk, stype, bedroom, bathroom, balcony, kitchen, hall, floor, size, price, location, city, state, feature, pimage, pimage1, pimage2, pimage3, pimage4, uid, status, mapimage, topmapimage, groundmapimage, totalfloor, isFeatured, amount) 
    VALUES ('$price', '$amount')";
